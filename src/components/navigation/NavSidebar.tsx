    ...
    return (
      ...
      >
        ...
        <div className="flex items-center h-14 px-5 gap-6">
          ...
          {items.length > 0 && (
            <button
              className="ml-auto md:hidden flex flex-col gap-1.5 p-1.5 rounded-[calc(var(--radius)*0.75)] text-fg-muted hover:text-fg-primary hover:bg-bg-elevated transition-colors duration-[var(--transition-speed)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
  ...
  (
    ...
    <aside
      ...
      className={cn(
        ...
        "transition-[width] duration-[var(--transition-speed)]",
        className,
      )}
            ...
            {group.items.map((item, ii) => (
              <a
                ...
                className={cn(
                  ...
                  "text-sm transition-colors duration-[var(--transition-speed)]",
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent",
