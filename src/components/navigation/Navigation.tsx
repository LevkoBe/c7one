  ...
  ({ className, ...props }, ref) => (
    <RadixTabs.List
      ...
      className={cn(
        ...
        'bg-[--color-bg-elevated] rounded-[--radius]',
  ...
  ({ className, ...props }, ref) => (
    <RadixTabs.Trigger
      ...
      className={cn(
        ...
        'text-sm font-medium text-[--color-fg-muted]',
        ...
        'data-[state=active]:bg-[--color-bg-overlay] data-[state=active]:text-[--color-fg-primary]',
            ...
            <li key={i} className="flex items-center gap-1.5">
              {i > 0 && (
                <svg
                  ...
                  className="text-[--color-fg-disabled] shrink-0"
                  aria-hidden
                >
              ...
              {isLast || !item.href ? (
                <span
                  className={cn(
                    'text-sm',
                    isLast ? 'text-[--color-fg-primary] font-medium' : 'text-[--color-fg-muted]',
                  )}
                ...
                <a
                  href={item.href}
                  className="text-sm text-[--color-fg-muted] hover:text-[--color-fg-primary] transition-colors duration-[--transition-speed]"
                >
                  {item.label}
                </a>
              )}
