...
export function Table<T extends object>({
  ...
  return (
    <div className={cn("w-full", className)}>
      <div className="w-full overflow-x-auto rounded [border-width:var(--border-width)] border-border">
              ...
              {columns.map((col) => (
                <th
                  ...
                  className={cn(
                    ...
                    col.sortable &&
                      "cursor-pointer select-none group hover:text-fg-primary transition-colors duration-[var(--transition-speed)]",
                  )}
              ...
              sorted.map((row, i) => (
                <tr
                  ...
                  className={cn(
                    ...
                    "bg-bg-base transition-colors duration-[var(--transition-speed)]",
  ...
  return (
    <div className={cn("flex items-center gap-1", className)}>
      <button
        ...
        className="px-2 py-1 text-xs rounded-[calc(var(--radius)*0.75)] text-fg-muted hover:bg-bg-elevated disabled:opacity-40 disabled:pointer-events-none transition-colors duration-[var(--transition-speed)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      >
        ←
      </button>
