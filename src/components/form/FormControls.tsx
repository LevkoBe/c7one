    ...
    <div className="flex items-center gap-2">
      <RadixSwitch.Root
        ...
        className={cn(
          ...
          "bg-bg-overlay transition-colors duration-[var(--transition-speed)]",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent",
      ...
      >
        <RadixSwitch.Thumb
          className={cn(
            ...
            "transition-transform duration-[var(--transition-speed)]",
    ...
    <div className="flex items-center gap-3 w-full">
      ...
      >
        <RadixSlider.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full bg-bg-overlay">
          <RadixSlider.Range className="absolute h-full bg-accent transition-all duration-[var(--transition-speed)]" />
        </RadixSlider.Track>
        {(props.value ?? props.defaultValue ?? [0]).map((_, i) => (
          <RadixSlider.Thumb
            ...
            className={cn(
              ...
              "shadow-sm transition-transform duration-[var(--transition-speed)]",
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent",
              "hover:scale-110",
