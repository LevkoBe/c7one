...
const headingBase =
  "text-fg-primary font-semibold leading-tight tracking-tight";

export const H1 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(headingBase, "text-4xl", className)}
      {...props}
    />
  ),
);
...
export const H2 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h2
      ref={ref}
      className={cn(headingBase, "text-3xl", className)}
      {...props}
    />
  ),
);
...
export const H3 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(headingBase, "text-2xl", className)}
      {...props}
    />
  ),
);
...
export const H4 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h4
      ref={ref}
      className={cn(headingBase, "text-xl", className)}
      {...props}
    />
  ),
);
...
export const H5 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h5
      ref={ref}
      className={cn(headingBase, "text-lg", className)}
      {...props}
    />
  ),
);
...
export const H6 = React.forwardRef<HTMLHeadingElement, HeadingProps>(
  ({ className, ...props }, ref) => (
    <h6
      ref={ref}
      className={cn(headingBase, "text-base", className)}
      {...props}
    />
  ),
);
      ...
      return (
        ...
        >
          <code
            ...
            className={cn("text-xs font-mono text-fg-primary", className)}
            {...props}
          >
            {children}
          </code>
...
>(({ className, ...props }, ref) => (
  <label
    ref={ref}
    className={cn("text-sm font-medium text-fg-primary select-none", className)}
    {...props}
  />
));
