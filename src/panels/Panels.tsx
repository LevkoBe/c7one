...
import { PanelVisibilityProvider, usePanelContext } from '../context/PanelContext'
...
export function PanelLeaf({ id, children, className, minSize, maxSize }: PanelLeafProps) {
